  ...
  Engine = (function() {
    ...
    function Engine() {
      ...
      this.update = function() {
        return Engine.prototype.update.apply(_this, arguments);
      };
      this.play = function() {
        return Engine.prototype.play.apply(_this, arguments);
      };
      this.pause = function() {
        return Engine.prototype.pause.apply(_this, arguments);
      };
      this.draw = function() {
        return Engine.prototype.draw.apply(_this, arguments);
      };
      this.mainLoop = function() {
        return Engine.prototype.mainLoop.apply(_this, arguments);
      };
      this.hud = new Hud();
