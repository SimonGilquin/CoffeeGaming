...
(function() {
  var Asteroid, Button, Drawable, Engine, Hud, Image, Screen, Text, Vessel, canvas, context, createAsteroidStore, createSurface, debug, enableLog, game, keymap, surface, translate,
    __slice = [].slice,
  ...
  Asteroid = (function() {
    ...
    Asteroid.prototype.drawAt = function(x, y) {
      ...
      return context.drawImage(Asteroid.image, drawnAt.x, drawnAt.y);
    };
