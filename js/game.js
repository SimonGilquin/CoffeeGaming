...
(function() {
  var Asteroid, Button, Drawable, Engine, Hud, Image, Screen, Text, Vessel, canvas, context, createAsteroidStore, createSurface, debug, distanceBetween, enableLog, game, keymap, translate,
    __slice = [].slice,
  ...
  Asteroid = (function() {
    ...
    Asteroid.prototype.draw = function() {
      ...
      if ((0 <= (_ref = this.position.x + 10) && _ref <= canvas.width + 20) && (0 <= (_ref1 = this.position.y + 10) && _ref1 <= canvas.height + 20)) {
        return context.drawImage(this.image, this.position.x - 10, this.position.y - 10);
      }
    };
